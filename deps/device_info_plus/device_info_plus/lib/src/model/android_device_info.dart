...
class AndroidDeviceInfo extends BaseDeviceInfo {
  ...
  static AndroidDeviceInfo fromMap(Map<String, dynamic> map) {
    return AndroidDeviceInfo._(
      ...
      supported32BitAbis: _fromList(map['supported32BitAbis'] as List<dynamic>),
      supported64BitAbis: _fromList(map['supported64BitAbis'] as List<dynamic>),
      supportedAbis: _fromList(map['supportedAbis'] as List<dynamic>),
      tags: map['tags'] as String,
      type: map['type'] as String,
      isPhysicalDevice: map['isPhysicalDevice'] as bool,
      systemFeatures: _fromList(map['systemFeatures'] as List<dynamic>),
...
class AndroidDisplayMetrics {
  ...
  static AndroidDisplayMetrics _fromMap(Map<String, dynamic> map) {
    return AndroidDisplayMetrics._(
      ...
      xDpi: (map['xDpi'] as num).toDouble(),
      yDpi: (map['yDpi'] as num).toDouble(),
    );
  }
}
