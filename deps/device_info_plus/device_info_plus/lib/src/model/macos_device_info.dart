...
class MacOsDeviceInfo extends BaseDeviceInfo {
  ...
  static MacOsDeviceInfo fromMap(Map<String, dynamic> map) {
    return MacOsDeviceInfo._(
      ...
      osRelease: map['osRelease'] as String,
      majorVersion: map['majorVersion'] as int,
      minorVersion: map['minorVersion'] as int,
      patchVersion: map['patchVersion'] as int,
      activeCPUs: map['activeCPUs'] as int,
      memorySize: map['memorySize'] as int,
      cpuFrequency: map['cpuFrequency'] as int,
      systemGUID: map['systemGUID'] as String?,
    );
  }
}
